# 로컬 geth 2노드 구축해서 통신하기 

로컬노드1실행: 
./build/bin/geth --datadir ./tempdata/node1 init ../genesis.json // 제네시스블락 세팅 이니셜라이징
...
옶션값을 주지 않으면 core/geneis.go 파일 기반 세팅.
...
Official golang implementation of the newthereum protocol.
